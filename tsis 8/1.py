...
background = pygame.image.load("C:\\pp2_22B\\pp2-22B050830-1\\tsis 8\\image\\doroga.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\\pp2_22B\\pp2-22B050830-1\\tsis 8\\image\\monetka.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\\pp2_22B\\pp2-22B050830-1\\tsis 8\\image\\vragi.png")
        self.rect = self.image.get_rect()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\\pp2_22B\\pp2-22B050830-1\\tsis 8\\image\\me.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(p1, coinss):
        # pygame.mixer.Sound("C:\\pp2_22B\\pp2-22B050830-1\\tsis 8\\music\\Doja Cat feat. The Weeknd - You Right.mp3").play()
        for entity in coinss:
            coin_score += 1
            entity.kill()
        c2 = Coin()
